  ...
  return (
    <View style={styles.homeUserconnected}>
      ...
      <View style={styles.frame27}>
        <TouchableOpacity>
          <ImageBackground
            ...
            source={{
              uri: /* dummy image */ "https://i.ytimg.com/vi/dUbNmJa3lNM/maxresdefault.jpg",
            }}
          />
        </TouchableOpacity>
      ...
      <View style={styles.frame28}>
        <TouchableOpacity>
          <ImageBackground
            style={styles.unsplashUTbcrtjp18g}
            source={{
              uri: /* dummy image */ "https://i0.wp.com/lapresse.tn/wp-content/uploads/2023/09/djerba.jpg?fit=850%2C491&ssl=1",
            }}
          />
        </TouchableOpacity>
        <View style={styles.frame26}>
          <View style={styles.frame21}>
            <Text style={styles.rockeymountain}>{`Djerba`}</Text>
            <View style={styles.group35}>
              <View style={styles.rectangle35} />
              <Text style={styles._87}>{`4.8`}</Text>
              <Svg
                style={styles.star3}
                width="12"
                height="11"
          ...
          <View style={styles.frame22}>
            ...
            <Text style={styles._20Jan2021}>{`14 - 20 Jan 2024`}</Text>
          </View>
          <View style={styles.frame25}>
            <View style={styles.frame23}>
              {/* RN-Flow:: can be replaced with <VuesaxOutlineDollarsquare /> */}
            ...
            <View style={styles.frame24}>
              ...
              <Text style={styles.canada}>{`Djerba`}</Text>
            </View>
          </View>
        </View>
      </View>
      <View style={styles.frame30}>
        <TouchableOpacity>
          <ImageBackground
            style={styles.unsplashUTbcrtjp18g}
            source={{
              uri: /* dummy image */ "https://www.leben-pur.ch/wp-content/uploads/2023/01/leben-pur-230105-15-16-002-1440x1080.jpg",
            }}
          />
        </TouchableOpacity>
        <View style={styles.frame26}>
          <View style={styles.frame21}>
            <Text style={styles.rockeymountain}>{`Chebika Tunisia`}</Text>
            <View style={styles.group35}>
              <View style={styles.rectangle35} />
              <Text style={styles._89}>{`3.8`}</Text>
              <Svg
                style={styles.star3}
                width="12"
                height="11"
          ...
          <View style={styles.frame22}>
            ...
            <Text style={styles._20Jan2021}>{`14 - 20 Jan 2021`}</Text>
          </View>
          <View style={styles.frame25}>
            <View style={styles.frame23}>
              {/* RN-Flow:: can be replaced with <VuesaxOutlineDollarsquare /> */}
            ...
            <View style={styles.frame24}>
              ...
              <Text style={styles.canada}>{`Tunisia`}</Text>
            </View>
          </View>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  tripContainer: {
    marginRight: 200, // Add any desired margin or padding
  },
  bottomNavigation: {
    flexDirection: "row",
