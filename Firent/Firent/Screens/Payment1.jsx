  ...
  return (
    <View style={styles.payment1}>
              ...
              <View>
                <View>
                  <View style={[styles.productParent, styles.parentFlexBox]}>
                    ...
                    <Text style={[styles.price1, styles.textTypo]}>
                      {trip.current} DT
                    </Text>
                  </View>
                  <View style={[styles.taxesParent, styles.parentFlexBox]}>
                    ...
                    <Text style={[styles.price2, styles.textTypo]}>
                      {total} DT
                    </Text>
                  </View>
                </View>
      ...
      <Pressable
        ...
        onPress={() => {
          navigation.navigate("Payment2", trip);
        }}
      >
