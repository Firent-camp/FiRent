    ...
    return (
        <View style={styles.trips}>
            <View style={styles.group3612}>
                <Svg style={styles.group3610} width="39" height="38" viewBox="0 0 39 38" fill="none" >
                    <Rect width="38.1013" height="38" rx="6" fill="#131316" />
                    <Path fillRule="evenodd" clipRule="evenodd" d="M23.8226 10.5209C24.1781 10.8546 24.3778 11.3071 24.3778 11.7788C24.3778 12.2506 24.1781 12.7031 23.8226 13.0368L17.5776 18.8957L23.8226 24.7547C24.168 25.0903 24.3592 25.5397 24.3549 26.0062C24.3506 26.4727 24.1511 26.919 23.7995 27.2489C23.4479 27.5787 22.9722 27.7659 22.475 27.7699C21.9777 27.774 21.4987 27.5946 21.141 27.2705L13.5553 20.1536C13.1997 19.82 13 19.3675 13 18.8957C13 18.4239 13.1997 17.9715 13.5553 17.6378L21.141 10.5209C21.4967 10.1874 21.9789 10 22.4818 10C22.9847 10 23.467 10.1874 23.8226 10.5209Z" fill="#686DCD" />
                </Svg>

                <View style={styles.group3}>
                    <Text style={styles.ourtrips}>
                        {`Our trips`}
                    </Text>
                </View>
            </View>
