      ...
      <View style={styles.group3566}>
        <View style={styles.group3565}>
          <View style={styles.group3527}>
            ...
            >
              <Path
                d="M170 86.5C170 134.549 131.607 174 84.2478 174C36.8881 174 0 134.549 0 86.5C0 38.4513 36.8881 0 84.2478 0C131.607 0 170 38.4513 170 86.5Z"
                fill="url(#pattern0)"
              />
              <Defs>
                <Pattern
                ...
                >
                  <Use
                    xlinkHref="#image0_54_1192"
                    transform="matrix(0.00236264 0 0 0.00234192 -0.00912758 -0.034133)"
                  />
                </Pattern>
                <Image
                  id="image0_54_1192"
                  width="427"
                  height="450"
                  xlinkHref={formData.image}
                />
              </Defs>
            </Svg>

            <TouchableOpacity
              style={styles.solarcameraminimalisticbold}
              onPress={pickImage}
            >
              <Svg
                style={styles.vector}
        ...
        <View style={styles.group3563}>
          ...
          <View style={styles.group3555}>
            <View style={styles.___group3545}>
              <Text style={styles.dateofbirth}>{`Adresse`}</Text>
              <View style={styles.___group3551}>
                <Svg
                  style={styles.___group3546}
                  width="342"
                  height="44"
                  viewBox="0 0 342 44"
                  fill="none"
