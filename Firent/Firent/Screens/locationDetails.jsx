...
export default function LocationDetails() {
    ...
    return (
        ...
        <View style={styles.locationDetails}>
            <View style={styles.frame61}>
                <TouchableOpacity onPress={() => setUrl('https://img.lamontagne.fr/aSVPzmqa8Koj6s-xoV-ATuQqCcOPMxht3yaXKZgwI0g/fit/657/438/sm/0/bG9jYWw6Ly8vMDAvMDAvMDYvNTIvODgvMjAwMDAwNjUyODg3NA.jpg')}>
                    <View style={styles.frame55}>
                        <ImageBackground style={styles.unsplashDD1fSz2HF1s} source={{ uri: /* dummy image */ 'https://img.lamontagne.fr/aSVPzmqa8Koj6s-xoV-ATuQqCcOPMxht3yaXKZgwI0g/fit/657/438/sm/0/bG9jYWw6Ly8vMDAvMDAvMDYvNTIvODgvMjAwMDAwNjUyODg3NA.jpg' }} />
                    </View>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setUrl('https://thumbs.dreamstime.com/b/beau-d-paysage-automne-avec-des-arbres-et-feuilles-au-soleil-en-ecosse-124278811.jpg')}>
                    <View style={styles.frame56}>
                        <ImageBackground style={styles.unsplashioJVccFmWxE} source={{ uri: /* dummy image */ 'https://thumbs.dreamstime.com/b/beau-d-paysage-automne-avec-des-arbres-et-feuilles-au-soleil-en-ecosse-124278811.jpg' }} />
                    </View>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setUrl('https://www.photo-paysage.com/albums/userpics/10001/155/normal_Le_canal_de_Chelles_-02.JPG')}>
                    <View style={styles.frame57}>
                        <ImageBackground style={styles.unsplashlh6cxuDOS8s} source={{ uri: /* dummy image */ 'https://www.photo-paysage.com/albums/userpics/10001/155/normal_Le_canal_de_Chelles_-02.JPG' }} />
                    </View>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setUrl('https://www.lonelyplanet.fr/sites/lonelyplanet/files/styles/article_main_image/public/media/article/image/istock-655664008.jpg?itok=hysZ9F3q')}>
                    <View style={styles.frame58}>
                        <ImageBackground style={styles.unsplashBi_5VsaOLnI} source={{ uri: /* dummy image */ 'https://www.lonelyplanet.fr/sites/lonelyplanet/files/styles/article_main_image/public/media/article/image/istock-655664008.jpg?itok=hysZ9F3q' }} />
                    </View>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setUrl('https://ceweblogfrbe.photoservices.nl/wp-content/uploads/2020/09/mark-harpur-K2s_YE031CA-unsplash-1-1024x683-1.jpg')}>
                    <View style={styles.frame59}>
                        <ImageBackground style={styles.unsplash5MV818tzxeo} source={{ uri: /* dummy image */ 'https://ceweblogfrbe.photoservices.nl/wp-content/uploads/2020/09/mark-harpur-K2s_YE031CA-unsplash-1-1024x683-1.jpg' }} />
                    </View>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setUrl('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSlJqeAAPwmcU2KNEEZnQ1WRmi0H5ZQ5Mlc_A&usqp=CAU')}>
                    <View style={styles.frame60}>
                        <ImageBackground style={styles.unsplash2WlTWZLnRc} source={{ uri: /* dummy image */ 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSlJqeAAPwmcU2KNEEZnQ1WRmi0H5ZQ5Mlc_A&usqp=CAU' }} />
                    </View>
                </TouchableOpacity>
            </View>
                ...
                <View style={styles.frame53}>
                    ...
                    <View style={styles.frame52}>
                        <View style={styles.vuesaxOutlineLocation}>
                            <Svg style={styles._vuesaxOutlineLocation} width="16" height="17" viewBox="0 0 16 17" fill="none" >
                                <Path d="M7.99998 9.94667C6.57998 9.94667 5.41998 8.79334 5.41998 7.36667C5.41998 5.94 6.57998 4.79333 7.99998 4.79333C9.41998 4.79333 10.58 5.94667 10.58 7.37334C10.58 8.8 9.41998 9.94667 7.99998 9.94667ZM7.99998 5.79333C7.13332 5.79333 6.41998 6.5 6.41998 7.37334C6.41998 8.24667 7.12665 8.95334 7.99998 8.95334C8.87332 8.95334 9.57998 8.24667 9.57998 7.37334C9.57998 6.5 8.86665 5.79333 7.99998 5.79333Z" fill="white" />
                                <Path d="M8 15.6733C7.01333 15.6733 6.01999 15.3 5.24666 14.56C3.28 12.6667 1.10666 9.64668 1.92666 6.05334C2.66666 2.79334 5.51333 1.33334 8 1.33334C8 1.33334 8 1.33334 8.00666 1.33334C10.4933 1.33334 13.34 2.79334 14.08 6.06001C14.8933 9.65334 12.72 12.6667 10.7533 14.56C9.97999 15.3 8.98666 15.6733 8 15.6733ZM8 2.33334C6.06 2.33334 3.56666 3.36668 2.90666 6.27334C2.18666 9.41334 4.16 12.12 5.94666 13.8333C7.1 14.9467 8.90666 14.9467 10.06 13.8333C11.84 12.12 13.8133 9.41334 13.1067 6.27334C12.44 3.36668 9.93999 2.33334 8 2.33334Z" fill="white" />
                            </Svg>
                        </View>
                ...
                <View style={styles.frame41}>
                    <View style={styles.frame35}>
                        <View style={styles.vuesaxBoldClock}>
                            <Svg style={styles._vuesaxBoldClock} width="24" height="24" viewBox="0 0 24 24" fill="none" >
                ...
                <View style={styles.frame43}>
                    <View style={styles.frame37}>
                        <View style={styles.vuesaxBoldRanking}>
                            <Svg style={styles._vuesaxBoldRanking} width="24" height="24" viewBox="0 0 24 24" fill="none" >
                                <Path d="M13.3 8.11001L14.62 10.75C14.8 11.11 15.28 11.47 15.68 11.53L18.07 11.93C19.6 12.19 19.96 13.29 18.86 14.39L17 16.26C16.69 16.57 16.51 17.18 16.61 17.62L17.14 19.93C17.56 21.75 16.59 22.46 14.98 21.51L12.74 20.18C12.33 19.94 11.67 19.94 11.26 20.18L9.00997 21.5C7.39997 22.45 6.42997 21.74 6.84997 19.92L7.37997 17.61C7.47997 17.18 7.29997 16.57 6.98997 16.25L5.13997 14.4C4.03997 13.3 4.39997 12.19 5.92997 11.94L8.31997 11.54C8.71997 11.47 9.19997 11.12 9.37997 10.76L10.7 8.12001C11.41 6.68001 12.59 6.68001 13.3 8.11001Z" fill="#686DCD" />
                                <Path d="M6 9.75C5.59 9.75 5.25 9.41 5.25 9V2C5.25 1.59 5.59 1.25 6 1.25C6.41 1.25 6.75 1.59 6.75 2V9C6.75 9.41 6.41 9.75 6 9.75Z" fill="#686DCD" />
                                <Path d="M18 9.75C17.59 9.75 17.25 9.41 17.25 9V2C17.25 1.59 17.59 1.25 18 1.25C18.41 1.25 18.75 1.59 18.75 2V9C18.75 9.41 18.41 9.75 18 9.75Z" fill="#686DCD" />
                                <Path d="M12 4.75C11.59 4.75 11.25 4.41 11.25 4V2C11.25 1.59 11.59 1.25 12 1.25C12.41 1.25 12.75 1.59 12.75 2V4C12.75 4.41 12.41 4.75 12 4.75Z" fill="#686DCD" />
                            </Svg>
                        </View>
                    </View>
            ...
            <Text style={styles.ifyouwishtoexperiencebreezybeachesswayingpalmtreesandquirkybeachshacksmakeyourwaytoBaliOurBalitourisdottedwithvolcanicmountainsiconicricepaddiesandvibrantnightlifeNowthatyouhavebookedyourexperientialtourpackage}>
                ...
                <TouchableOpacity>
                    <View style={styles.frame47}>
                        ...
                        <View style={styles.vuesaxBoldArrowcircleright}>
                            <Svg style={styles._vuesaxBoldArrowcircleright} width="24" height="24" viewBox="0 0 24 24" fill="none" >
                                <Path d="M12 2C6.49 2 2 6.49 2 12C2 17.51 6.49 22 12 22C17.51 22 22 17.51 22 12C22 6.49 17.51 2 12 2ZM14.79 12.53L11.26 16.06C11.11 16.21 10.92 16.28 10.73 16.28C10.54 16.28 10.35 16.21 10.2 16.06C9.91 15.77 9.91 15.29 10.2 15L13.2 12L10.2 9C9.91 8.71 9.91 8.23 10.2 7.94C10.49 7.65 10.97 7.65 11.26 7.94L14.79 11.47C15.09 11.76 15.09 12.24 14.79 12.53Z" fill="white" />
                            </Svg>
