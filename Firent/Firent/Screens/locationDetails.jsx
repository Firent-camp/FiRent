    ...
    return (
        <View style={styles.locationDetails}>
            ...
            <View style={styles.frame54}>
                <ImageBackground style={styles._unsplashDD1fSz2HF1s} source={{ uri: /* dummy image */ 'https://idinterdesign.ca/wp-content/uploads/2016/07/paysage-ID-02.jpg' }} />
            ...
            <View style={styles.frame44}>
                <View style={styles.frame41}>
                    <View style={styles.frame35}>
                        {/* RN-Flow:: can be replaced with <VuesaxBoldClock  /> */}
                ...
                <View style={styles.frame42}>
                    <View style={styles.frame36}>
                        {/* RN-Flow:: can be replaced with <VuesaxBoldRouting2  /> */}
                ...
                <View style={styles.frame43}>
                    <View style={styles.frame37}>
                        {/* RN-Flow:: can be replaced with <VuesaxBoldRanking  /> */}
