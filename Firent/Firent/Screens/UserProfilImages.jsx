...
import { View, Text, ImageBackground, StyleSheet, Image, StatusBar, TouchableOpacity } from 'react-native';
...
export default function Userprofilimages() {
    ...
    return (
        <View style={styles.userprofilimages}>
            <Svg style={styles.line9} width="416" height="1" viewBox="0 0 416 1" fill="none" >
                <Path d="M-1 0.727051L417 0.727051" stroke="#545454" strokeWidth="0.54595" strokeLinecap="round" />
            </Svg>

            <Svg style={styles.line8} width="44" height="3" viewBox="0 0 44 3" fill="none" >
                <Line x1="1.0919" y1="1.9081" x2="42.5841" y2="1.9081" stroke="#686DCD" strokeWidth="2.1838" strokeLinecap="round" />
            </Svg>
                        ...
                        <View style={styles.frame3298}>
                            ...
                            <View style={styles.frame2809}>
                                ...
                                <View style={styles.frame2811}>
                                    ...
                                    <Text style={styles._______images}>
                                        {`Images`}
                                    </Text>
                                </View>
                            </View>
                        ...
                        <View style={styles.group3585}>
                            <TouchableOpacity style={styles.group3584}>
                                <View style={styles.group3580}>
                                    <Svg style={styles.ellipse11} width="35" height="34" viewBox="0 0 35 34" fill="none" >
                                        <Path d="M32.5 16.9505C32.5 24.8568 25.86 31.4011 17.5 31.4011C9.13995 31.4011 2.5 24.8568 2.5 16.9505C2.5 9.0443 9.13995 2.5 17.5 2.5C25.86 2.5 32.5 9.0443 32.5 16.9505Z" fill="#F5F5F5" stroke="white" strokeWidth="5" />
                                    </Svg>

                                    <View style={styles.lineDesignEditline}>
                                        <Svg style={styles.group} width="15" height="16" viewBox="0 0 15 16" fill="none" >
                                            <Path d="M3.24995 10.8985L10.9667 3.42403L9.89082 2.38194L2.17408 9.85639V10.8985H3.24995ZM3.88071 12.3724H0.652344V9.24544L9.35289 0.818073C9.49557 0.67991 9.68907 0.602295 9.89082 0.602295C10.0926 0.602295 10.2861 0.67991 10.4288 0.818073L12.5813 2.90299C12.7239 3.04119 12.804 3.22861 12.804 3.42403C12.804 3.61945 12.7239 3.80687 12.5813 3.94508L3.88071 12.3724V12.3724ZM0.652344 13.8464H14.348V15.3204H0.652344V13.8464Z" fill="black" />
                                        </Svg>
