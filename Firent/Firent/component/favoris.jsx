...
export default function Favoris({ wishlists }) {
  const navigation = useNavigation();

  return (
    <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
      {wishlists.map((wishlist, index) => (
        <View key={index} style={styles.group3605}>
          <View style={styles.group38}>
            ...
            <View style={styles.group68}>
              <Text style={styles.idaho}>{wishlist.trip.location}</Text>
              <Svg
                style={styles.vector}
                width="10"
                height="13"
          ...
          <View style={styles.group35}>
            ...
            <Text style={styles._9}>{wishlist.trip.rating}</Text>
            <Svg
              style={styles.star3}
              width="12"
              height="11"
